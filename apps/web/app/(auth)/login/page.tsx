    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0d14]">
      ...
      <div style={{ width: "100%", maxWidth: 380, padding: "0 24px" }}>
        ...
        <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div>
            <label style={{ fontFamily: "'Geist',sans-serif", fontSize: 12, color: "rgba(248,249,251,0.45)", display: "block", marginBottom: 6 }}>Lösenord</label>
            <input
              type="password"
              value={password}
        ...
        <p style={{ marginTop: 28, textAlign: "center", fontFamily: "'Geist',sans-serif", fontSize: 13, color: "rgba(248,249,251,0.35)" }}>
          Inget konto?{" "}
          <a href="/signup" style={{ color: "rgba(248,249,251,0.70)", textDecoration: "none" }}
